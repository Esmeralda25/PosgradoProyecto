...
-- Tiempo de generación: 20-09-2021 a las 20:33:41
...
(11, 'Modelo de utilidad o patente', 3, 2, 7, 16),
...
INSERT INTO `desgloce_evaluacion` (`id`, `evaluacion_id`, `docentes_id`, `concepto`, `valor`, `observacion`) VALUES
(1, 1, 33, 'Criterio1', '87', 'Le falto bastante'),
(2, 1, 33, 'Criterio 2', '100', 'Ok'),
(3, 1, 33, 'Criterio 3', '90', 'Le falto poco'),
(4, 2, 33, 'Criterio1', '87', 'Le falto bastante'),
(5, 2, 33, 'Criterio 2', '100', 'Ok'),
(6, 2, 33, 'Criterio 3', '90', 'Le falto poco'),
(10, 4, 32, 'Criterio1', '5', 'Nose'),
(11, 4, 32, 'Criterio 2', '6', 'Nose'),
(12, 4, 32, 'Criterio 3', '9', 'Nose');
...
INSERT INTO `evaluaciones` (`id`, `proyecto_id`, `calificacion`, `observaciones`, `fecha`) VALUES
(4, 7, '6.6666666666667', NULL, '2021-09-20');
...
CREATE TABLE `evidencias` (
  ...
  `reporte` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `evidencias` (`id`, `adquirido_id`, `archivo`, `reporte`) VALUES
(1, 14, NULL, NULL),
(2, 14, NULL, NULL),
(3, 15, NULL, NULL),
(4, 14, NULL, NULL),
