...
--
-- Servidor: localhost
-- Tiempo de generación: 21-05-2021 a las 13:44:12
...
--
-- Estructura de tabla para la tabla `docente_pe`
--

CREATE TABLE `docente_pe` (
  `id` int NOT NULL,
...
--
-- Indices de la tabla `docente_pe`
--
ALTER TABLE `docente_pe`
  ADD KEY `fk_docente_pe_docentes1_idx` (`docente_id`),
  ADD KEY `fk_docente_pe_pes1_idx` (`pe_id`);
...
--
-- Filtros para la tabla `docente_pe`
--
ALTER TABLE `docente_pe`
  ADD CONSTRAINT `fk_docente_pe_docentes1` FOREIGN KEY (`docente_id`) REFERENCES `docentes` (`id`),
  ADD CONSTRAINT `fk_docente_pe_pes1` FOREIGN KEY (`pe_id`) REFERENCES `pes` (`id`);
