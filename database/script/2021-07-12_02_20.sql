...
-- Tiempo de generación: 12-07-2021 a las 19:19:03
...
(2, 'Cesar Gabriel', 'estudiante@gmail.com', '$2y$10$PxczttwKzPuvvKMlu2a.juzdIZss3e2ItfdMO8stg65K0LN9W.tr.', 4),
...
(8, 'Marina Espinoza', 'marina@gmail.com', '$2y$10$PxczttwKzPuvvKMlu2a.juzdIZss3e2ItfdMO8stg65K0LN9W.tr.', 5),
(9, 'Antonieta Sanchez', 'antonieta@gmail.com', '$2y$10$PxczttwKzPuvvKMlu2a.juzdIZss3e2ItfdMO8stg65K0LN9W.tr.', 1),
(10, 'Yael Gomez', 'yael@gmail.com', '$2y$10$PxczttwKzPuvvKMlu2a.juzdIZss3e2ItfdMO8stg65K0LN9W.tr.', 3),
...
(3, '2do semestre', '2021-06-28', '2021-06-25', 'Concluido', 2, 5),
(4, '1er semestre', '2021-06-02', '2021-07-16', 'Inicio', 3, 6),
(5, '2do semestre', '2021-06-02', '2021-07-16', 'Seguimiento', 1, 6),
(6, '3er semestre', '2021-06-26', '2021-07-23', 'Evaluacion', 2, 6),
(8, 'Agosto-Diembre 2020', '2021-08-09', '2021-12-17', 'Comienzo', 3, 5),
(9, 'Agosto-Diembre 2020', '2021-08-09', '2021-12-17', 'Concluido', 1, 7),
(10, 'Enero -junio 2021', '2021-06-15', '2021-06-06', 'Seguimiento', 2, 7),
...
CREATE TABLE `proyectos` (
  ...
  `calificacion_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `proyectos` (`id`, `titulo`, `hipotesis`, `objetivos`, `objetivose`, `reporte`, `avance`, `estudiante_id`, `comite`, `periodo_id`, `calificacion_id`) VALUES
(2, 'Titulo del proyecto', 'Hipotesis x', 'Objetivo del proyecto', 'especificos', NULL, NULL, 2, 10, 3, NULL),
(4, 'Proyecto Yael', 'Nueva Hipotesis', 'Nuevo Objetivo General', 'Nuevos Especificos', NULL, NULL, 10, 9, 2, NULL),
(5, 'Proyecto de Alberto', 'Hipotesis de Alberto', 'O general de Alberto', 'O espcifico de Alberto', NULL, NULL, 4, 8, 3, NULL),
(6, 'Titulo Nuevo', 'Nueva Hipotesis', 'Nuevos Objetivos', 'Nuevos Objetivos Especificos', '', NULL, 8, 11, 2, NULL),
(7, 'Nuevo Titulo', 'Nueva Hipotesis', 'Nuevos Objetivos', 'Nuevos Especificos', NULL, NULL, 9, 7, 3, NULL),
(8, 'Jacobo', 'Jacobo', 'Jacobo', 'Jacobo', NULL, NULL, 7, 7, 2, NULL),
(9, 'Natalia', 'Natalia', 'Natalia', 'Natalia', NULL, NULL, 11, 8, 2, NULL),
(10, 'Yael', 'Yael', 'Yael', 'Yael', NULL, NULL, 10, 9, 3, NULL),
(11, 'Jesus', 'Jesus', 'Jesus', 'Jesus', NULL, NULL, 16, 10, 2, NULL),
(12, 'Sofia', 'Sofia', 'Sofia', 'Sofia', NULL, NULL, 18, 11, 3, NULL);
...
ALTER TABLE `proyectos`
  ...
  ADD KEY `fk_proyectos_calificaciones1_idx` (`calificacion_id`);
...
--
ALTER TABLE `proyectos`
  ADD CONSTRAINT `fk_proyectos_calificaciones1` FOREIGN KEY (`calificacion_id`) REFERENCES `mydb`.`calificaciones` (`id`),
