...
-- Tiempo de generación: 22-09-2021 a las 03:18:40
...
(5, 'Presentar Producto', 'Segunda quincena de Septiembre', 7, 16),
(6, 'Nueva Actividad', 'marzo-junio', 6, 16),
(7, 'Actividad 2', 'marzo-junio', 6, 16),
(8, 'Actividad 3', 'marzo-junio', 6, 16);
...
INSERT INTO `adquiridos` (`id`, `que`, `cuantos_prog`, `cuantos_cumplidos`, `proyecto_id`, `periodos_id`) VALUES
(1, 'conferencias', 3, NULL, 2, 15),
(2, 'Articulos JCR Aceptados o Publicados', 1, NULL, 2, 15),
(3, 'Conferencias Internacionales.', 3, NULL, 2, 15),
(10, 'Compromiso 2p', 2, 2, 7, 16),
(11, 'Modelo de utilidad o patente', 3, 3, 7, 16),
(14, 'Compromiso 2p', 3, 3, 6, 16),
(15, 'Compromiso 1p', 3, 3, 6, 16);
...
INSERT INTO `criterios` (`id`, `rubrica_id`, `descripcion`) VALUES
(1, 3, 'Identifica el problema'),
(2, 3, 'Propone solución'),
(3, 1, 'Criterio1'),
(4, 1, 'Criterio 2'),
(5, 1, 'Criterio 3'),
(6, 5, 'El título es auto explicativo.'),
(7, 5, 'La hipotesis se puede probar'),
(8, 5, 'La hipotesis se puede probar');
...
--
-- Volcado de datos para la tabla `desgloce_evaluacion`
--

INSERT INTO `desgloce_evaluacion` (`id`, `evaluacion_id`, `concepto`, `valor`, `observacion`) VALUES
(1, 1, 'Criterio1', '87', 'Le falto bastante'),
(2, 1, 'Criterio 2', '100', 'Ok'),
(3, 1, 'Criterio 3', '90', 'Le falto poco'),
(4, 2, 'Criterio1', '87', 'Le falto bastante'),
(5, 2, 'Criterio 2', '100', 'Ok'),
(6, 2, 'Criterio 3', '90', 'Le falto poco'),
(10, 4, 'Criterio1', '5', 'Nose'),
(11, 4, 'Criterio 2', '6', 'Nose'),
(12, 4, 'Criterio 3', '9', 'Nose');
...
(20, 'PeHugo', 'pehugo@gmail.com', '$2y$10$axH/x7aD2bUP2iRT8aQ2Teh5UMz7vEJusLWLAhiAvnbSfMZ8r/wLm', 6, 16),
(21, 'PeLuis', 'peluis@gmail.com', '$2y$10$XRyMuEkkQdbuLJLmc8hRC.IfxaGMdcsoCp2DblTYi1Xvtvl4Bpc5O', 6, 16);
...
INSERT INTO `evaluaciones` (`id`, `proyecto_id`, `calificacion`, `observaciones`, `fecha`, `docente_id`, `periodo_id`) VALUES
(4, 7, '6.6666666666667', NULL, '2021-09-20', 32, 16);
...
INSERT INTO `evidencias` (`id`, `adquirido_id`, `archivo`) VALUES
(1, 14, NULL),
(2, 14, NULL),
(3, 15, NULL),
(4, 14, NULL),
(5, 15, NULL),
(12, 10, '20_7_10_e_01 infografia.pdf');
...
(9, 'Generacion 2020 - 2023', 'Entraron en 2020', 6),
(10, 'Generacion 2021 - 2024', 'Entraron en 2021.', 6);
...
CREATE TABLE `periodos` (
  ...
  `estado` enum('Inicio','Comprometerse','Seguimiento','Reportar','Evaluacion','Concluido') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
(16, 'Primer año', '2020-01-20', '2020-12-20', 'Evaluacion', 1, 9),
(17, 'Prueba', '2021-01-01', '2021-12-01', NULL, 5, 10);
...
INSERT INTO `reportes` (`id`, `reporte`, `proyecto_id`, `periodo_id`) VALUES
(1, '20_7_16_r_70.pdf', 7, 16);
...
INSERT INTO `rubricas` (`id`, `nombre`, `tipo`, `pe_id`) VALUES
(1, 'Rubirca Para Evaluar', 'Numerica', 2),
(2, 'Rubrica de prueba 2', 'Alfanumerica', 2),
(3, 'Rubica para Aprobar', 'Alfanumerica', 5),
(4, 'Rubrica de evaluacion', 'Numerica', 5),
(5, 'Rubrica para aprobar una prueba', 'Alfanumerica', 6),
(7, 'Rubrica para evaluar una prueba', 'Numerica', 6);
...
ALTER TABLE `adquiridos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_adquiridos_proyectos1_idx` (`proyecto_id`),
...
ALTER TABLE `criterios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Criterios_Rubricas1_idx` (`rubrica_id`);
...
ALTER TABLE `desgloce_evaluacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_desgloce_evaluacion_evaluaciones1` (`evaluacion_id`);
...
ALTER TABLE `evaluaciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_evaluaciones_proyectos1_idx` (`proyecto_id`),
  ADD KEY `fk_evaluaciones_docentes1_idx` (`docente_id`),
  ADD KEY `fk_evaluaciones_periodos1_idx` (`periodo_id`);
...
ALTER TABLE `evidencias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_evidencias_adquiridos1_idx` (`adquirido_id`);
...
ALTER TABLE `reportes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_reportes_proyectos1_idx` (`proyecto_id`),
  ADD KEY `fk_reportes_periodos1_idx` (`periodo_id`);

--
-- Indices de la tabla `rubricas`
--
ALTER TABLE `rubricas`
  ADD PRIMARY KEY (`id`,`pe_id`),
  ADD KEY `fk_rubricas_pes1_idx` (`pe_id`);
...
--
ALTER TABLE `criterios`
  ADD CONSTRAINT `fk_Criterios_Rubricas1` FOREIGN KEY (`rubrica_id`) REFERENCES `rubricas` (`id`);

--
-- Filtros para la tabla `desgloce_evaluacion`
--
ALTER TABLE `desgloce_evaluacion`
  ADD CONSTRAINT `fk_desgloce_evaluacion_evaluaciones1` FOREIGN KEY (`evaluacion_id`) REFERENCES `evaluaciones` (`id`);
...
--
ALTER TABLE `evaluaciones`
  ADD CONSTRAINT `fk_evaluaciones_docentes1` FOREIGN KEY (`docente_id`) REFERENCES `docentes` (`id`),
  ADD CONSTRAINT `fk_evaluaciones_periodos1` FOREIGN KEY (`periodo_id`) REFERENCES `periodos` (`id`);

--
-- Filtros para la tabla `evidencias`
--
ALTER TABLE `evidencias`
  ADD CONSTRAINT `fk_evidencias_adquiridos1` FOREIGN KEY (`adquirido_id`) REFERENCES `adquiridos` (`id`);
...
--
ALTER TABLE `reportes`
  ADD CONSTRAINT `fk_reportes_periodos1` FOREIGN KEY (`periodo_id`) REFERENCES `periodos` (`id`),
  ADD CONSTRAINT `fk_reportes_proyectos1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`);

--
-- Filtros para la tabla `rubricas`
--
ALTER TABLE `rubricas`
  ADD CONSTRAINT `fk_rubricas_pes1` FOREIGN KEY (`pe_id`) REFERENCES `pes` (`id`);
COMMIT;
