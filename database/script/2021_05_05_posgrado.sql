...
--
-- Servidor: localhost
-- Tiempo de generación: 06-05-2021 a las 00:15:41
...
INSERT INTO `estudiantes` (`id`, `usarios_id`, `correo`, `password`, `pes_id`) VALUES
(1, 12, 'estudiante@gmail.com', '$2y$10$f7p4.WR8QQzEm7lVkwpsx.iuVL.NbalmlWmaeR/KVOidtPp13heo.', 1);
...
(1, 'Coordinador 1', 'cordinador@gmail.com', '$2y$10$f7p4.WR8QQzEm7lVkwpsx.iuVL.NbalmlWmaeR/KVOidtPp13heo.', 'Programa educativo 1');
...
ALTER TABLE `docentes`
  ADD PRIMARY KEY (`id`,`usarios_id`);

--
-- Indices de la tabla `estudiantes`
--
ALTER TABLE `estudiantes`
  ADD PRIMARY KEY (`id`,`usarios_id`,`pes_id`),
