...
--
-- Servidor: localhost
-- Tiempo de generación: 25-05-2021 a las 21:12:00
...
CREATE TABLE `avals` (
  `id` bigint UNSIGNED NOT NULL,
  `Justificacion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Asesor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Revisor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Revisor2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `egresados` (
  `id` bigint UNSIGNED NOT NULL,
  `NoControl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `APaterno` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `AMaterno` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `PlanDeEstudios` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `empleados` (
  ...
  `AMaterno` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `departamento` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `empleados` (`id`, `Nombre`, `APaterno`, `AMaterno`, `email`, `departamento`, `Foto`, `Telefono`, `password`, `created_at`, `updated_at`) VALUES
(1, 'Lizette Priscila', 'Espinoza', 'Corzo', 'priscila.corzooo@gmail.com', 'escolares', 'nohay.jpg', '9612325427', '$2y$10$N25cP2KNa720UI9fiTDTiO7hnWYx62ad4PH2soZuKECVIZgyMOAgy', NULL, NULL),
(2, 'Itzel Alejandra', 'Hernandez', 'Cuevas', 'itzelhernandez367@gmail.com', 'division', 'nohay.jpg', '9613184211', '$2y$10$EGAUT4Ge9UgRIjaBjAqEDeYzGF/1YKzaXzQLcEHWzozt1YLq9C/Ra', NULL, NULL),
(3, 'Manuel Alejandro', 'Vazquez', 'Molina', 'manuel10881@hotmail.com', 'jsistemas', 'nohay.jpg', '9613875821', '$2y$10$6o5nxkMGKlolpBKLka7GSeVXwO8z5AK7VwvVZIma8riQ/06VUJrfC', NULL, NULL),
(4, 'Jose Fernando', 'Perez', 'Garcia', 'josefernandoperezgarcia98@gmail.com', 'asistemas', 'nohay.jpg', '9611652148', '$2y$10$HqRxGbeF4dxN.tx1AiSSbOrG1gTZ5sEppDS5oVt96jH4zd9.Nga2i', NULL, NULL),
(5, 'Eliezer Berlain', 'Gomez', 'Gomez', 'L17270141@tuxtla.tecnm.mx', 'jelectrica', 'nohay.jpg', '9191336022', '$2y$10$yxzxuWW6Wd4uRjvbIH6sIenWCkK4mbQf2AHDFrmC89l5jP4cEYkeS', NULL, NULL),
(6, 'Jorge', 'Lopez', 'Gomez', 'jorfc.-@gmail.com', 'aelectrica', 'nohay.jpg', '9611364489', '$2y$10$jmNPhCWe.PkDv1KqzQ3GnOuwFey2zHE0akfem9dCksleNj4jSp7Ym', NULL, NULL),
(7, 'Ramiro de Jesus', 'Balam', 'Lopez', 'L16270739@tecnm.tutla.mx', 'aelectronica', 'nohay.jpg', '9611229978', '$2y$10$zG3VZqmkwnD5YNRnzt6jwucZoCzxCXR0m1FxBIDdD65Hfl0Jt60kO', NULL, NULL);
...
CREATE TABLE `jurados` (
  `id` bigint UNSIGNED NOT NULL,
  `Presidente` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Secretario` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vocal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Suplente` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Corroborado` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tramites` (
  ...
  `egresado_id` bigint UNSIGNED DEFAULT NULL,
  `estado` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `liberacion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_recepcion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hora_recepcion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lugar_recepcion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(7, 4, 1, 'cita agendada', NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-25 20:45:50', '2021-05-25 20:45:50'),
(8, 5, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-25 20:52:00', '2021-05-25 20:52:00'),
(9, 6, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-25 20:52:04', '2021-05-25 20:52:04'),
(10, 5, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-25 20:52:11', '2021-05-25 20:52:11');
