...
--
-- Servidor: localhost
-- Tiempo de generación: 14-07-2021 a las 18:01:24
...
INSERT INTO `proyectos` (`id`, `titulo`, `hipotesis`, `objetivos`, `objetivose`, `reporte`, `avance`, `estudiante_id`, `comite`, `periodo_id`) VALUES
(2, 'Titulo del proyecto', 'Hipotesis x', 'Objetivo del proyecto', 'especificos', NULL, NULL, 2, NULL, NULL),
(4, 'Proyecto Yael', 'Nueva Hipotesis', 'Nuevo Objetivo General', 'Nuevos Especificos', NULL, NULL, 10, 1, 2),
(5, 'Proyecto de Alberto', 'Hipotesis de Alberto', 'O general de Alberto', 'O espcifico de Alberto', NULL, NULL, 4, 5, 3);
