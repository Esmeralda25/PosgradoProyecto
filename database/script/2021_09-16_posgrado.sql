...
-- Tiempo de generación: 17-09-2021 a las 03:31:11
...
(1, 'Revision', 'Enero-Septiembre', 2, 5),
(2, 'Desarrollo del producto', 'Febrero - Septiembre', 7, 16),
(3, 'Depurar el producto', 'Septiembre primer quincena', 7, 16),
(4, 'actividad numero uno', '01 septiembre - 30 septiembre', 2, 5),
(6, 'actividad numero tres', '01 septiembre - 30 septiembre', 2, 5),
(8, 'actividad numero cinco', '01 octubre-02 octubre', 2, 4);
...
(1, 'conferencias', 3, NULL, 2, 5),
(2, 'Articulos JCR Aceptados o Publicados', 1, NULL, 2, 5),
(3, 'Conferencias Internacionales.', 3, NULL, 2, 5),
(4, 'Modelo de utilidad o patente', 2, NULL, 2, 5),
(6, 'Compromiso 1p', 1, 1, 7, 16),
(8, 'Modelo de utilidad o patente', 1, 1, 7, 16),
(10, 'Compromiso 2p', 2, 1, 7, 16),
(11, 'Conferencias Internacionales.', 1, NULL, 2, 4),
(12, 'Articulos JCR Aceptados o Publicados', 1, NULL, 2, 4),
(13, 'Articulos JCR Aceptados o Publicados', 1, NULL, 2, 4),
(14, 'Conferencias Internacionales.', 1, NULL, 2, 4);
...
CREATE TABLE `desgloce_evaluacion` (
  `id` int(11) NOT NULL,
  `evaluaciones_id` int(11) DEFAULT NULL,
...
(2, 'Cesar Gabriel', 'estudiante@gmail.com', '$2y$10$PxczttwKzPuvvKMlu2a.juzdIZss3e2ItfdMO8stg65K0LN9W.tr.', 5, 5),
...
(2, '1er semestre', '2021-06-14', '2021-06-16', 'Inicio', 1, 5),
(3, '2do semestre', '2021-06-28', '2021-06-25', 'Concluido', 1, 5),
(4, '1er semestre', '2021-06-02', '2021-07-16', 'Comprometerse', 1, 6),
(5, '2do semestre', '2021-06-02', '2021-07-16', 'Reportar', 1, 6),
...
(16, 'Primer año', '2020-01-20', '2020-12-20', 'Reportar', 1, 9),
...
(2, 'Proyecto de Cesar', 'Hipotesis x', 'Objetivo del proyecto', 'especificos', NULL, NULL, 2, 6, 5, 0),
