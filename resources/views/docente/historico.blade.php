            ...
            <div class="col-10"> 
                <div class="card col-12">
                    <div class="card-header">
                        <h1 class="card-title font-weight-bold" style="font-size: 40px;">HITORICO</h1>
                    </div>
                    ...
                    @foreach ($proyecto->periodos as $periodo)
                        ...
                        $cuantos = 0;
                        $suma = 0;
                        foreach ($proyecto->valoraciones($periodo->id)->get() as $evaluacion) {
                        ...
                        @endphp
                            ...
                            <table class="table table-dark table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <th>
                                            @forelse ($proyecto->compromisos( $periodo->id )->get() as $compromiso)
                                                <li>
                            ...
                            <table class="table table-dark table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <th>
                                            @forelse ($proyecto->actividades( $periodo->id )->get() as $actividad)
